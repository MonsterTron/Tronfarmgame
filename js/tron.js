...
async function main() {
    ...
    if (typeof(window.tronWeb) === 'undefined') {
        ...
        tronland = await tronWeb.contract().at("TAbuKuS4KG9UVUsjT5ai8VJA7kGouoVNRe");
...
function mainloop() {
    ...
    tronWeb.trx.getBalance(tronWeb.defaultAddress['base58']).then(result => {
      ...
      tronWeb.trx.getBalance('TAbuKuS4KG9UVUsjT5ai8VJA7kGouoVNRe').then(result => {
        contractBal = result;
   ...
   tronland.totalPayout().call().then(result => {
    ...
    tronland.plantationOf(currentAddr).call().then(result => {
        ...
        var factory_divident_0 = plantationOf0 * 2;
        var factory_divident_1 = plantationOf1 * 6;
        var factory_divident_2 = plantationOf2 * 12;
        var factory_divident_3 = plantationOf3 * 24;
        var factory_divident_4 = plantationOf4 * 96;
        var factory_divident_5 = plantationOf3 * 768;
