...
function mainloop() {
   ...
   tronland.totalPayout().call().then(result => {
    ...
    tronland.plantationOf(currentAddr).call().then(result => {
        ...
        var factory_divident_0 = plantationOf0 * 1;
        var factory_divident_1 = plantationOf1 * 3;
        var factory_divident_2 = plantationOf2 * 6;
        var factory_divident_3 = plantationOf3 * 12;
        var factory_divident_4 = plantationOf4 * 48;
        var factory_divident_5 = plantationOf3 * 384;
